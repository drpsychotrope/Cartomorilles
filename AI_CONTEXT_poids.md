# 🍄 CARTOMORILLES — AI Context v2.3.5 | 2026-03-26 17:04 UTC | full | session:poids

> Auto-généré par `prepare_context.py` — optimisé Claude Opus
> Project hash: `c09288dc00`

> 🔀 SESSION PARALLÈLE : **poids**
> Branche git : `session/poids`
> Créée le : 2026-03-26T17:04:14.549624+00:00
>
> **Fichiers modifiables (verrouillés) :**
> - 🔓 `config.py` (partagé — attention aux conflits)
>
...
- SESSION 'poids' : modifier UNIQUEMENT config.py
</rules>
...
- Ne PAS modifier : data_loader.py, grid_builder.py, scoring.py, visualize.py, landcover_detector.py, species_enricher.py, main.py, weather.py
</forbidden>
...
├── config.py                  ✅ (715L) — 🍄 CARTOMORILLES — Configuration du modèle (v2.2.0) ◄ SESSION
...
<current_focus>
FOCUS DE CETTE SESSION : poids — config.py
DESCRIPTION : amélioration des poids
HORS SCOPE (ne pas toucher) : data_loader.py, grid_builder.py, landcover_detector.py, main.py, scoring.py, species_enricher.py, visualize.py, weather.py
...
INTERDIT: ___
SESSION: poids
BRANCHE: session/poids
</checkpoint>

---
_Généré le 2026-03-26 17:04 UTC | 579 lignes | ~1174 lignes restantes pour prompt + code_