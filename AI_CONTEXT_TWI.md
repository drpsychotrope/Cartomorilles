# 🍄 CARTOMORILLES — AI Context v2.3.5 | 2026-03-26 17:03 UTC | full | session:TWI

> Auto-généré par `prepare_context.py` — optimisé Claude Opus
> Project hash: `c09288dc00`

> 🔀 SESSION PARALLÈLE : **TWI**
> Branche git : `session/TWI`
> Créée le : 2026-03-26T17:03:22.011321+00:00
>
> **Fichiers modifiables (verrouillés) :**
> - 🔒 `grid_builder.py` (exclusif)
> - 🔒 `main.py` (exclusif)
...
- SESSION 'TWI' : modifier UNIQUEMENT grid_builder.py, main.py, visualize.py, scoring.py
</rules>
...
- Ne PAS modifier : data_loader.py, landcover_detector.py, species_enricher.py, weather.py
</forbidden>
...
├── grid_builder.py            ✅ (2154L) — 🍄 CARTOMORILLES — Construction du maillage et c... ◄ SESSION
├── scoring.py                 ✅ (928L) — scoring.py — Modèle multicritère pondéré pour C... ◄ SESSION
├── visualize.py               ✅ (1250L) — visualize.py — Cartomorilles v2.3.5 ◄ SESSION
...
📊 `715L | 504L code | 5fn | 0cls | 030fc707`
...
📊 `1250L | 1047L code | 1fn | 1cls | d76ac1ab`
...
<current_focus>
FOCUS DE CETTE SESSION : TWI — grid_builder.py, main.py, visualize.py, scoring.py
DESCRIPTION : amélioration du twi
HORS SCOPE (ne pas toucher) : data_loader.py, landcover_detector.py, species_enricher.py, weather.py
...
---
_Généré le 2026-03-26 17:03 UTC | 648 lignes | ~1105 lignes restantes pour prompt + code_